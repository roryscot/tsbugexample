...
import { createPredictiveAnalytics } from "./graphql/mutations";
const client = generateClient();
export default function PredictiveAnalyticsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPrediction(initialValues.prediction);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createPredictiveAnalytics.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PredictiveAnalyticsCreateForm")}
      {...rest}
    >
      <TextField
        label="Uuid"
