...
import { createOvulationCycleAnalysis } from "./graphql/mutations";
const client = generateClient();
export default function OvulationCycleAnalysisCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setAnalysis(initialValues.analysis);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createOvulationCycleAnalysis.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "OvulationCycleAnalysisCreateForm")}
      {...rest}
    >
      <TextField
        label="Uuid"
