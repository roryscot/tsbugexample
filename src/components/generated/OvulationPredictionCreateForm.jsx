...
import { createOvulationPrediction } from "./graphql/mutations";
const client = generateClient();
export default function OvulationPredictionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPredictedOvulationDate(initialValues.predictedOvulationDate);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createOvulationPrediction.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "OvulationPredictionCreateForm")}
      {...rest}
    >
      <TextField
        label="Uuid"
