...
import { createBasalBodyTemperature } from "./graphql/mutations";
const client = generateClient();
export default function BasalBodyTemperatureCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createBasalBodyTemperature.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BasalBodyTemperatureCreateForm")}
      {...rest}
    >
      <TextField
        label="Uuid"
