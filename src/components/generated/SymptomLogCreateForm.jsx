...
import { createSymptomLog } from "./graphql/mutations";
const client = generateClient();
export default function SymptomLogCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setSymptom(initialValues.symptom);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createSymptomLog.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SymptomLogCreateForm")}
      {...rest}
    >
      <TextField
        label="Uuid"
