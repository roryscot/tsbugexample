...
import { createFertilityWindow } from "./graphql/mutations";
const client = generateClient();
export default function FertilityWindowCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createFertilityWindow.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "FertilityWindowCreateForm")}
      {...rest}
    >
      <TextField
        label="Uuid"
