...
import { createSupportGroup } from "./graphql/mutations";
const client = generateClient();
export default function SupportGroupCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createSupportGroup.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SupportGroupCreateForm")}
      {...rest}
    >
      <TextField
        label="Uuid"
